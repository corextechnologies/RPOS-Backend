"""Kitchen sub-chef provisioning routes."""
...
from app.schemas.kitchen import SubChefCreate, SubChefOut
...
def list_sub_chefs(
    ...
    data = [SubChefOut.model_validate(u).model_dump(mode="json") for u in rows]
