...
# with `inputs`), not from a stored recipe. The recipe authoring/reference
# endpoints that lived here are gone. RecipeService still powers the CENTRAL
# kitchen (app/api/v1/kitchen/production.py), which is untouched.
